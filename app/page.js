...
export default function Home() {
  ...
  useEffect(() => {
    const typed = new Typed(el.current, {
      strings: ['Coding', 'Web Development', 'Software Engineering', 'Data Science', 'Mobile App Development', 'DevOps', 'Cloud Computing', 'Cybersecurity', 'UI/UX Design', 'Machine Learning' ],
      typeSpeed: 50,
    });
